...
const PERMIT_FLOW=[
  {n:"01",title:"Tentukan usaha dan seluruh KBLI",tag:"Fondasi",summary:"Pisahkan kegiatan utama dan kegiatan pendukung dengan kode KBLI final 5 digit.",detail:"Cocokkan uraian KBLI dengan proses yang benar-benar dilakukan—bukan hanya nama perusahaan. Catat produk/jasa, rantai proses, tahap proyek, dan hubungan antar-KBLI.",output:"Daftar KBLI utama dan pendukung + batas ruang lingkup",system:["KBLI OSS",LINKS.kbli]},
  {n:"02",title:"Lengkapi profil teknis proyek",tag:"Data proyek",summary:"Tetapkan skala, kapasitas, proses, utilitas, bahan, limbah, serta lokasi kegiatan.",detail:"Siapkan kapasitas dengan satuan yang tepat, diagram proses, luas lahan, koordinat/polygon, kebutuhan air dan energi, bahan kimia, sumber emisi, air limbah, B3/LB3, serta tahapan konstruksi–operasi.",output:"Project brief, process flow, neraca awal, dan polygon",system:["Mulai di EnviroTrack","#penapisan"]},
  {n:"03",title:"Daftar dan validasi risiko di OSS",tag:"Legalitas usaha",summary:"OSS menentukan keluaran perizinan berdasarkan KBLI, ruang lingkup, skala, dan tingkat risiko.",detail:"Isi data pelaku usaha dan setiap bidang usaha. Keluaran dapat berupa NIB saja atau disertai Sertifikat Standar/izin sesuai tingkat risiko dan aturan sektor. Persyaratan dasar dan komitmen tetap harus dituntaskan.",output:"NIB + keluaran perizinan berusaha berbasis risiko",system:["OSS RBA",LINKS.oss]},
  {n:"04",title:"Pastikan kesesuaian ruang dan tapak",tag:"Persyaratan dasar",summary:"Periksa kesesuaian pemanfaatan ruang serta irisan kawasan sensitif sejak awal.",detail:"Uji polygon terhadap RTR, kawasan hutan, konservasi, gambut, karst, pesisir/ruang laut, sempadan, kawasan industri, dan batas administrasi. Jalur serta kewenangan dapat berubah jika proyek lintas wilayah atau berada di kawasan khusus.",output:"Dokumen/konfirmasi kesesuaian ruang + hasil overlay",system:["OSS / PTSP",LINKS.oss]},
  {n:"05",title:"Tapis AMDAL, UKL-UPL, atau SPPL",tag:"Penapisan lingkungan",summary:"Jenis, skala, proses, dan sensitivitas lokasi menentukan dokumen lingkungan.",detail:"Cocokkan proyek dengan daftar wajib pada Permen LHK 4/2021 beserta ketentuan sektor. Jangan memakai KBLI saja: kapasitas, teknologi, luasan, lokasi, dan kegiatan pendukung ikut menentukan hasil.",output:"Hasil penapisan dan jalur dokumen lingkungan",system:["Permen LHK 4/2021","https://peraturan.go.id/id/permen-lhk-no-4-tahun-2021"]},
  {n:"06",title:"Susun dan ajukan dokumen lingkungan",tag:"Persetujuan lingkungan",summary:"Isi kajian dan kedalaman proses mengikuti hasil penapisan.",detail:"AMDAL umumnya mencakup KA-ANDAL, ANDAL, dan RKL-RPL; UKL-UPL memuat upaya pengelolaan dan pemantauan; SPPL berupa pernyataan kesanggupan untuk kegiatan yang tidak wajib AMDAL/UKL-UPL. Lengkapi data teknis, rona awal, dampak, rencana pengelolaan, pemantauan, dan bukti pelibatan sesuai jalurnya.",output:"Keputusan kelayakan/PKPLH atau dokumen lingkungan yang sesuai",system:["AMDALNet",LINKS.amdalnet]},
  {n:"07",title:"Penuhi persetujuan teknis yang terpicu",tag:"Teknis lingkungan",summary:"Air limbah, emisi, dan pengelolaan limbah memerlukan jalur teknis sesuai sumber aktual.",detail:"Inventaris setiap aliran dan sumber. Bila diwajibkan, susun kajian/standar teknis, desain fasilitas, titik penaatan, baku mutu, pemantauan, commissioning, serta SLO. Kode limbah B3 harus dikonfirmasi dari sumber dan karakteristik—bukan dipilih secara generik.",output:"Pertek/rincian teknis/SLO dan persetujuan terkait bila wajib",system:["PP 22/2021","https://peraturan.go.id/id/pp-no-22-tahun-2021"]},
  {n:"08",title:"Selesaikan izin sektoral dan daerah",tag:"Kewenangan",summary:"Tambahkan PB UMKU, persyaratan sektor, dan layanan daerah yang relevan.",detail:"Migas, pertambangan, kesehatan, pangan, kehutanan, perkebunan, energi, transportasi, dan sektor lain memiliki kewajiban khusus. Periksa juga PTSP dan JDIH provinsi/kabupaten/kota berdasarkan lokasi dan kewenangan proyek.",output:"Daftar izin sektoral, PB UMKU, dan persyaratan lokal",system:["JDIHN",LINKS.jdihn]},
  {n:"09",title:"Bangun, verifikasi, lalu patuh beroperasi",tag:"Operasi",summary:"Izin bukan titik akhir: seluruh komitmen harus diterjemahkan menjadi kontrol dan bukti.",detail:"Laksanakan RKL-RPL/UKL-UPL, SOP, fasilitas pengendalian, sampling, manifest, neraca, pelaporan, kompetensi, inspeksi, dan kalender kepatuhan. Perubahan kapasitas, proses, lokasi, KBLI, atau dampak perlu ditapis kembali sebelum dijalankan.",output:"Matriks komitmen, bukti pelaksanaan, dan laporan berkala",system:["SIMPEL",LINKS.simpel]}
];
...
function renderHome(){
  return `<div class="landing">
    <section class="landing-hero">
      ...
      <div class="hero-map" aria-label="Ringkasan alur EnviroTrack"><span class="map-orbit orbit-one"></span><span class="map-orbit orbit-two"></span><div class="hero-node node-kbli"><small>01</small><b>KBLI & skala</b></div><div class="hero-node node-impact"><small>02</small><b>Dampak & lokasi</b></div><div class="hero-node node-permit"><small>03</small><b>Izin & bukti</b></div><div class="hero-center"><span>e</span><b>EnviroTrack</b><small>Satu alur yang terhubung</small></div></div>
    </section>

    <section class="landing-section landing-intro"><div><span class="landing-kicker">GAMBARAN BESAR</span><h3>Perizinan bukan satu formulir dan tidak selalu lurus.</h3></div><p>Beberapa proses berjalan berurutan, sebagian dapat paralel, dan sebagian baru aktif jika ada pemicu teknis tertentu. Urutan akhirnya mengikuti tingkat risiko, sektor, skala, lokasi, kewenangan, serta kesiapan dokumen proyek.</p></section>

    <section class="permit-flow" id="alur-izin">${PERMIT_FLOW.map((x,i)=>`<details class="permit-step" ${i<2?"open":""}><summary><span class="permit-number">${x.n}</span><div><span class="permit-tag">${x.tag}</span><b>${x.title}</b><small>${x.summary}</small></div><span class="permit-toggle">+</span></summary><div class="permit-detail"><p>${x.detail}</p><div><small>HASIL YANG DISIAPKAN</small><b>${x.output}</b></div><a href="${x.system[1]}" ${x.system[1].startsWith("http")?'target="_blank" rel="noopener noreferrer"':""}>Buka ${x.system[0]} ↗</a></div></details>`).join("")}</section>
    ...
    <section class="landing-section systems-section"><div><span class="landing-kicker">EKOSISTEM RESMI</span><h3>Tracker mengarahkan tugas ke sistem dan sumber yang tepat.</h3></div><div class="system-grid">${[["OSS","NIB, risiko, perizinan berusaha",LINKS.oss],["AMDALNet","Dokumen dan persetujuan lingkungan",LINKS.amdalnet],["SIMPEL","Pemantauan dan pelaporan lingkungan",LINKS.simpel],["SPEED / PLB3","Pengelolaan limbah B3",LINKS.speed],["JDIHN","Regulasi pusat dan daerah",LINKS.jdihn]].map(x=>`<a href="${x[2]}" target="_blank" rel="noopener noreferrer"><span>↗</span><b>${x[0]}</b><small>${x[1]}</small></a>`).join("")}</div></section>

    <section class="landing-cta"><div><span class="landing-kicker">SIAP MENENTUKAN JALUR PROYEK?</span><h3>Mulai dari kegiatan yang benar-benar dilakukan.</h3><p>Masukkan KBLI utama dan pendukung, lalu EnviroTrack akan mempersempit pertanyaan, satuan, sumber dampak, kandidat limbah, regulasi, dan tugas.</p></div><button class="primary hero-primary" data-view="screening" data-step="0">Mulai penapisan →</button></section>
    <p class="landing-disclaimer">EnviroTrack adalah alat bantu penapisan dan pengelolaan pekerjaan. Hasilnya bersifat indikatif; keputusan resmi tetap mengikuti OSS, AMDALNet, instansi berwenang, serta regulasi yang berlaku.</p>
  </div>`;
}
