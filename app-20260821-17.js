...
function setKbli(data){
  state.kblis=[data];markNeedsRescreen("KBLI utama berubah");const profile=profileForCode(data.code);
...
function addKbli(data){
  ...
  state.kblis.push({...data,code});markNeedsRescreen("KBLI pendukung berubah");
