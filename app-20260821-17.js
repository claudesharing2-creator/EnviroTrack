...
function startNewFromEntry(){closeEntryGate(false);state=createNewProjectState();renderView();maybeStartOnboarding();}
...
document.addEventListener("click",e=>{
  ...
  const directAction=e.target.closest("[data-action]");if(directAction?.dataset.action==="open-onboarding"){e.preventDefault();showOnboarding();return;}if(directAction?.dataset.action==="new-project"){e.preventDefault();state=createNewProjectState();renderView();return;}
